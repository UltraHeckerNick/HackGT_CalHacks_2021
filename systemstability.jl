...
# ╔═╡ b2aa245e-4f4b-4831-a261-c872ae00aef9
begin
	using Plots
	using PlutoUI
	using Roots
...
# ╔═╡ 6dc22a70-74ce-41a8-8c99-22f568c87aef
den_G(s) = s^2 + 2*s + 16 #

# ╔═╡ 4a0f4724-2090-4a19-83c4-0dcbb7156413
G(s) = (32)/(den_G(s)) #Transfer Function 

# ╔═╡ f7304bfb-656c-4369-b144-de90b15f4180
@bind s NumberField(0:0.01:10000) #angular frequency (rad/s)

# ╔═╡ 90049e92-cb52-4083-858c-d1413c163abc
den_G(10)

# ╔═╡ 2e422c83-f6ca-466c-9a6a-47f12109dbed
zero = find_zeros(den_G,-10,10)

# ╔═╡ 7614684b-315e-44f0-a7cc-208a90fc8b92
s

# ╔═╡ 2c49125f-d546-4ede-b800-f597a77a7902
begin
	if (real(zero[1]) < 0 | real(zero[2]) < 0)
		println("The system is unstable")
	elseif (real(zero[1]) == 0 | real(zero[2]) == 0) 
...
# ╔═╡ 88cfa194-db2b-4e49-9371-4ab3d4e95143
s_plot = 0:0.01:100

# ╔═╡ 5b5745cc-8369-4e99-ab5c-5535296d5754
begin
	transfer = tf(32,[1 2 16])
	gr()
	plot(G,s_plot)
end
...
git-tree-sha1 = "4dde63e9b219dce0c5eb3402704f771057e30635"
